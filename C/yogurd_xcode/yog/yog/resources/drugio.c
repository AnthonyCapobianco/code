...
get_limit_then_print_logs(char *string)
{
        ...
        static char string_copy[10];
       
        static size_t string_length = 1; string_length = strlen(string);
        ...
        static unsigned int id_limit; id_limit = parse_string_to_uint(string_copy);
...
show_logs(void)
{
        ...
        is_first_sqlite_statement = false;
